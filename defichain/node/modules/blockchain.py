class Blockchain:
    ...
    def getgov(self, name: str) -> {}:  # 13
        ...
        :type name: str
        :return: {id:{...}} (array) Json object with variable information
    ...
    def verifytxoutproof(self, proof: str) -> [str]:  # 32
        ...
        :type proof: str
        :return: ["txid"] (array, strings) The txid(s) which the proof commits to, or empty array if the proof can not be validated
        """

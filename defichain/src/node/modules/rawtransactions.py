...
class Rawtransactions:
    ...
    def analyzepsbt(self, psbt):  # 01
        return self.node.rpc.call("analyzepsbt", psbt)

    def combinepsbt(self, txs):  # 02
        return self.node.rpc.call("combinepsbt", txs)

    def combinerawtransaction(self, txs):  # 03
        return self.node.rpc.call("combinerawtransaction", txs)
    ...
    def converttopsbt(self, hexstring, permitsigdata=None, iswitness=None):  # 04
        ...
        return self.node.rpc.call("converttopsbt", hexstring, permitsigdata, iswitness)

    def createpsbt(self, inputs, outputs, locktime=None, replaceable=None):  # 05
        locktime = 0 if locktime is None else locktime
        return self.node.rpc.call("createpsbt", inputs, outputs, locktime, replaceable)

    def createrawtransaction(self, inputs, outputs, locktime=None, replaceable=None):  # 06
        locktime = 0 if locktime is None else locktime
        return self.node.rpc.call("createrawtransaction", inputs, outputs, locktime, replaceable)

    def decodepsbt(self, psbt):  # 07
        return self.node.rpc.call("decodepsbt", psbt)

    def decoderawtransaction(self, hexstring, iswitness=None):  # 08
        return self.node.rpc.call("decoderawtransaction", hexstring, iswitness)

    def decodescript(self, hexstring):  # 09
        return self.node.rpc.call("decodescript", hexstring)

    def finalizepsbt(self, psbt, extract=None):  # 10
        return self.node.rpc.call("finalizepsbt", psbt, extract)
    ...
    def fundrawtransaction(self, hexstring, changeAddress=None, changePosition=None, change_type=None,
        ...
        return self.node.rpc.call("fundrawtransaction", hexstring, options.build(), iswitness)

    def getrawtransaction(self, txid, verbose=None, blockhash=None):  # 12
        verbose = False if verbose is None else verbose
        return self.node.rpc.call("getrawtransaction", txid, verbose, blockhash)

    def joinpsbts(self, txs):  # 13
        return self.node.rpc.call("joinpsbts", txs)

    def sendrawtransaction(self, hexstring, maxfeerate=None):  # 14
        return self.node.rpc.call("sendrawtransaction", hexstring, maxfeerate)
    ...
    def signrawtransactionwithkey(self, hexstring, privatekey, prevtxs=None, sighashtype=None):  # 15
        ...
        return self.node.rpc.call("signrawtransactionwithkey", hexstring, privatekey, prevtxs, sighashtype)

    def testmempoolaccept(self, rawtxs, maxfeerate=None):  # 16
        return self.node.rpc.call("testmempoolaccept", rawtxs, maxfeerate)

    def utxoupdatepsbt(self, psbt, descriptors=None):  # 17
        return self.node.rpc.call("utxoupdatepsbt", psbt, descriptors)

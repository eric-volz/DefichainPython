...
The documentation website is hosted via GitHub Pages. All build files
...
This folder contains all the files that define the documentation. These
can be compiled and are saved in the ``/build`` folder as HTML.
...
The compiled documentation is now accessible via the ``index.html`` in

...
def test_appointoracle():  # 01
    ...
    string = r".* RPC_INVALID_REQUEST: Test AppointOracleTx execution failed:\ntx not from foundation member"
...
def test_removeoracle():  # 11
    oracleid = "a4492224b78b065d3c044e65e4968e9b326f1b19b615b50f79d3ab58df10f2c5"
    string = r".* RPC_INVALID_REQUEST: Test RemoveOracleAppointTx execution failed:\ntx not from foundation member"
    with pytest.raises(BadRequest, match=string):
...
def test_setoracledata():  # 12
    ...
    string = r".* RPC_INVALID_ADDRESS_OR_KEY: Incorrect authorization for df1qxejhhu8xjx5mfh33khaz2fnlt8jwcyar450gtr"
...
def test_updateoracle():  # 13
    ...
    string = r".* RPC_INVALID_REQUEST: Test UpdateOracleAppointTx execution failed:\ntx not from foundation member"
    with pytest.raises(BadRequest, match=string):
